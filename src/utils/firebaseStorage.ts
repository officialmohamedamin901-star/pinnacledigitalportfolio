...
export async function uploadImageToStorage(
  ...
  if (typeof imageInput === 'string') {
    if (imageInput.startsWith('data:')) {
      console.log('[Storage Step 1/4] Converting dataUrl to Blob...');
  ...
  console.log(`[Storage Step 1/4] Initializing upload for path: "${storagePath}" (Size: ${(blob.size / 1024).toFixed(2)} KB, Type: ${fileType})`);
